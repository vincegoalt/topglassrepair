    ...
    <section className={`relative flex items-center ${heightClasses} overflow-hidden`}>
      ...
      <div className={`relative container mx-auto px-4 flex flex-col ${alignmentClasses} z-10`}>
        <div className={contentWidthClasses}>
          ...
          {description && (
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 mb-6 md:mb-8 animate-fade-in stagger-1 leading-relaxed">
              {description}
            </p>
          )}
          ...
          {features && features.length > 0 && (
            <div className="flex flex-wrap gap-2 sm:gap-3 mb-6 md:mb-8 animate-fade-in stagger-2">
              {features.map((feature, index) => (
                <span
                  key={index}
                  className="glass px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-white text-xs sm:text-sm font-medium flex items-center gap-1 sm:gap-2"
                >
                  <svg className="w-3 h-3 sm:w-4 sm:h-4 text-accent" fill="currentColor" viewBox="0 0 20 20">
          ...
          {/* Trust indicators */}
          <div className="mt-8 md:mt-12 flex flex-wrap items-center gap-4 sm:gap-6 md:gap-8 text-white/80 animate-fade-in stagger-4">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <span className="text-xs sm:text-sm font-medium">4.8+ Rating</span>
            </div>
            <div className="flex items-center gap-1 sm:gap-2">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 text-accent" fill="currentColor" viewBox="0 0 20 20">
